...
def punctuate_and_highlight(review_text, sentiment_text):
    """
    Punctuates the review text using a pretrained model, capitalizes sentences, and highlights the full sentence encapsulating the sentiment_text.
    ...
    """
    # Use the model to punctuate the text
    ...
    # Capitalize sentences while preserving proper names
