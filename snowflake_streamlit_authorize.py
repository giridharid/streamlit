...
authorization_endpoint = st.secrets["oauth"]["authorization_endpoint"]
token_endpoint = st.secrets["oauth"]["token_endpoint"]

# Step 1: OAuth Authorization
st.title("Hotel Insights Dashboard with OAuth")
...
if "code" not in st.experimental_get_query_params():
    ...
    # Step 3: Snowflake Connection Using OAuth Token
            ...
            if selected_hotel:
                ...
                if not insights.empty:
                    ...
                    if not reviews.empty:
                        ...
                        # Pagination setup
                        reviews_per_page = st.selectbox("Reviews per page:", options=[10, 25, 50], index=1)  # Default to 25
